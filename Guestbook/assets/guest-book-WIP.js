fetch(
    `https://opensheet.elk.sh/13OqoZ_6_T2ouop9z5srzOyT6lyNyxK690DCGkki_Ud0/Form+Responses+1`
)
    .then((res) => res.json())
    .then((data) => {
	...
	for(var i = 0; i < 5 && i < data.length; i++){
		...
		document.getElementById("json").innerHTML += `
                ...
                <div class="entry-text">
                    <p>I’m writing you a note because I think that I should. What do you think of this note? Did I write it well? Let me know. </p>
                </div>
            </div>`
...
/// Profanity Filter - Needs improvement 
...
subscribeForm.setAttribute("style", "-webkit-animation: fadeIn 1s; animation: fadeIn 1s;  animation-fill-mode: forwards;"); 
	 ...
	 /// Reset form after showing user message of violation
